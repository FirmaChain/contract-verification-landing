...
const NetworkSelect = ({ idx, setIdx, sx }: { idx: number; setIdx: any; sx?: IKeyValue }) => {
    ...
    const LIST = ["COLOSSEUM", "IMPERIUM-4"];
    ...
    return (
        <Stack onMouseOver={() => setOpen(true)} onMouseOut={() => setOpen(false)} sx={{ width: "100%", position: "relative" }}>
            <Stack
                direction="row"
                gap="5px"
                sx={{
            ...
            >
                <Stack
                    sx={{
                        ...
                        padding: "8px 0",
                        borderRadius: "4px",
                        boxShadow: open ? "0 1px 10px 0 rgba(0, 0, 0, 0.16)" : "none",
                    }}
                >
                    {LIST.map((one: string, thisIdx: number) => (
                        <Stack
                            ...
                            sx={{
                                ...
                                padding: "0 8px",
                                ".arrow": {
                                    color: idx === thisIdx ? "#316ff5" : "#343539",
                                },
                                ":hover": {
                                    color: "#fff",
