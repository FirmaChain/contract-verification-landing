...
import { IC_ARROW_RIGHT_BLUE, IC_ARROW_RIGHT_WHITE, IC_OPEN_IN_NEW_GREY } from "../constants/images";
...
export const OutlinedBlueButton = ({ title, sx, onClick, textOnly }: { title: string; sx?: IKeyValue; onClick?: () => void; textOnly?: boolean }) => {
    return (
        <Stack
            onClick={onClick}
            direction="row"
...
export const OutlinedWhiteButton = ({ title, sx, onClick }: { title: string; sx?: IKeyValue; onClick?: () => void }) => (
    <Stack
        onClick={onClick}
        direction="row"
        justifyContent="center"
...
export const ContainedBlueButton = ({ title, sx, onClick }: { title: string; sx?: IKeyValue; onClick: () => void }) => (
    <Stack
        onClick={onClick}
        className="buttonHover"
        alignItems="center"
...
export const PCHeaderButton = ({ menu, sx, onClick }: { menu: string; sx?: IKeyValue; onClick?: () => void }) => (
    <Stack
        onClick={onClick}
        className="buttonHover"
        direction="row"
...
export const FooterGotoButton = ({ menu, sx, onClick }: { menu: string; sx?: IKeyValue; onClick?: () => void }) => (
    <Stack
        onClick={onClick}
        direction="row"
        alignItems="center"
    ...
    >
        ...
        <img src={IC_OPEN_IN_NEW_GREY} alt="" style={{ width: "20px" }} draggable={false} />
    </Stack>
);
...
export const ListSelectBox = ({ title, nowIdx, idx, onClick }: { title: string; onClick: any; nowIdx: number; idx: number }) => (
    <Stack justifyContent="center" onClick={onClick} sx={{ minHeight: "48px", p: "0 14px", cursor: "pointer" }}>
        <Typography
            sx={{
                fontFamily: Lato,
                fontSize: "16px",
